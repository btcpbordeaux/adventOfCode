    ...
    function adventDaySix (a) {
        ...
        for (var i = 0; i < a.length; i++) {
            ...
            t = a[i].split(" ");
            if (t[0] == "turn") {
                var start = t[2], end = t[4];
                var xo = Number(start.split(":")[0]), xf = Number(end.split(":")[0]);
                var yo = Number(start.split(":")[1]), yf = Number(end.split(":")[1]);
                for (var n = xo; n <= xf; n++) {
                    for (var m = yo; m <= yf; m++) {
                        var key = "x"+n+"y"+m+"";
                        if (t[1] == "off") {
                            points[key][0] = false;
                            (points[key][1] > 0) ? points[key][1]-- : points[key][1];
                        }
                        else if (t[1] == "on") {
                            points[key][0] = true;
                            points[key][1]++;
                ...
                var start = t[1], end = t[3];
                var xo = Number(start.split(":")[0]), xf = Number(end.split(":")[0]);
                var yo = Number(start.split(":")[1]), yf = Number(end.split(":")[1]);
                for (var n = xo; n <= xf; n++) {
                    for (var m = yo; m <= yf; m++) {
                        var key = "x"+n+"y"+m+"";
                            points[key][0] = !points[key][0];
                            points[key][1] += 2;
        ...
        return points; //get no of true from points
    };
    ...
    console.log(getOn(adventDaySix(st)));
